...
![Instructions on how to create an integration. Gif animation.](../../assets/20230917_11ty-mit-notion-verbinden_1.gif)
...
![Instructions on how to assign an integration. Gif animation](../../assets/20230917_11ty-mit-notion-verbinden_2.gif)
...
…
			...
			if (images) {
				for (j = 0; j < images.length; j++) {
					...
					let imgPath = "src/public/img/" + imgRenamed;
					download(imgUrl, "src/public/img/", { filename: imgRenamed });
